...
$yr_url = 'http://www.yr.no/sted/Estland/Lääne-Virumaa/Metsavälja';
...
class YRDisplay
{
    ...
    var $yr_vindrettninger = array(
        'p&otilde;hjast', 'p&otilde;hjast-kirdest', 'kirdest', 'idast-kirdest',
        'idast', 'idast-kagust', 'kagust', 'kagust-l&otilde;unast',
...
EOT;
    ...
    private function getErrorMessage() {
        if (isset($this->yr_data['ERROR'])) {
            ...
            //die(retar($error));
            $this->ht .= '<p style="color:red; background:black; font-weight:900">' . $error . '</p>';
            return true;
        }
        return false;
    }
